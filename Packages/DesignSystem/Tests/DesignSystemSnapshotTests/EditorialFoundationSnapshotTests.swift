...
@MainActor
@Suite("Editorial Foundation Render Guards")
struct EditorialFoundationSnapshotTests {
    private let compactWidth: CGFloat = 320

    @Test("editorial foundation renders in normal light mode")
    func normalRender() {
        ...
        assertRenders(
            view,
            label: "editorial foundation — normal light",
            size: size
        )
    }

    @Test("editorial foundation renders at AX5 in dark mode")
    func accessibility5Render() {
        ...
        assertRenders(
            view,
            label: "editorial foundation — AX5 dark",
            size: size
        )
    }
