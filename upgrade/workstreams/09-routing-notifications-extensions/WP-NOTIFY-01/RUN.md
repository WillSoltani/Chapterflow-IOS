...
You are the sole implementation owner for **WP-NOTIFY-01 — Complete exact notification, widget, and Live Activity routing**. Complete this one package through its guarded development Git lifecycle, or stop with precise evidence. Do not implement another package.
...
5. Prove deterministic permission/token/routing/account behavior and publish stable final-device scenarios for WP-DEVICE-01.
