...
You are the sole implementation owner for **WP-OFFLINE-01 — Make downloads and offline synchronization restorable**. Complete this one package through its guarded development Git lifecycle, or stop with precise evidence. Do not implement another package.
...
6. Localize download/sync/storage status and generate the complete candidate-head native matrix.
