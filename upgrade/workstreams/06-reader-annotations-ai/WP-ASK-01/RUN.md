...
You are the sole implementation owner for **WP-ASK-01 — Make Ask streaming, privacy, and citations exact**. Complete this one package through its guarded development Git lifecycle, or stop with precise evidence. Do not implement another package.
...
6. Generate candidate-head compact/iPad/AX/keyboard/real-locale/pseudo-long/RTL/VoiceOver/contrast/motion evidence for Ask states.
7. Clear and cancel all owner-bound Ask state across account A → sign out → account B; unknown ownership restores nothing.
