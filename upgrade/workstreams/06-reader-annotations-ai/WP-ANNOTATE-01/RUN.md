...
You are the sole implementation owner for **WP-ANNOTATE-01 — Align notes, highlights, and bookmarks with one durable contract**. Complete this one package through its guarded development Git lifecycle, or stop with precise evidence. Do not implement another package.
...
1. Use WP-CONTRACT-02 to select an exact canonical capability/shape for notes, highlights, and bookmarks; stop on incompatible product scope.
