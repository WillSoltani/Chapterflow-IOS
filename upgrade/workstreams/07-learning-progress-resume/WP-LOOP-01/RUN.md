...
You are the sole implementation owner for **WP-LOOP-01 — Compose the complete learning loop and exact durable resume**. Complete this one package through its guarded development Git lifecycle, or stop with precise evidence. Do not implement another package.
...
6. Add package-owned localization and generate the complete candidate-head native matrix for the composed loop.
