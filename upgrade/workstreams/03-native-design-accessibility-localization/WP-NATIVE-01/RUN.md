...
6. implement target-owned localized Share/Action capture, signed-out, pending, failure, and committed
   ...
   initializer labels and void callback types solely for source compatibility, but make that legacy
   Save/Ask path fail closed: do not invoke the void callback, enter committed/success, announce
   success, dismiss, or open; clear busy state, retain payload/note, keep Cancel available, and show
